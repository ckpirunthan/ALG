...
for y in range(1, 21):
    ...
    def sample_raster_around_point(raster_path, point_geopackage_path):
        ...
        with open("F:/CSU/site3/clipped_MS_quads/quads/quad"+str(y)+"_window.csv", 'w', newline='') as csvfile:
    ...
    # Example usage:
    raster_file_path = "F:/CSU/site3/site3_micasense.tif"
    point_geopackage_path = "F:/CSU/site3/clipped_MS_quads/quads/quad"+str(y)+".gpkg"
